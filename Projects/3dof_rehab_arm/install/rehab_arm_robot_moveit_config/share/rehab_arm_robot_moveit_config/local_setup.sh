...
: ${AMENT_CURRENT_PREFIX:="/home/dat/Workspace/3dof_rehab_arm/install/rehab_arm_robot_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rehab_arm_robot_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rehab_arm_robot_moveit_config/environment/path.sh"
